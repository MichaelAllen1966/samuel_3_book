...
%TC:ignore
\include{5_additional_material/title}
\maketitle
%TC:endignore
...
\section{Methods}
\input{2_methods/data}
\input{2_methods/model_choice}
\input{2_methods/feature_selection}
\input{2_methods/shap_general}

\section{Results}
\input{3_results/feature_selection}
\input{3_results/shap_general}
...
%TC:ignore
\include{6_supplement/notebook_links}
%TC:endignore
