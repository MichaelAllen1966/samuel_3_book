...
Length of stay prediction has an $R^2$ of $\sim$0.18, suggesting our known clinical features predict only about 20\% of the variance in length of stay. Given that limited predictive performance, features that help predict length of stay are similar in order of contribution to those that predict clinical outcome.
