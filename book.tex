...
%TC:ignore
\include{book/5_additional_material/title}
\maketitle
\tableofcontents
%TC:endignore
...
\input{book/1_intro/intro}

\section{Methods}
\input{book/2_methods/data}
\input{book/2_methods/model_choice}
\input{book/2_methods/feature_selection}
\input{book/2_methods/shap_general}

\section{Results}
\input{book/3_results/feature_selection}
\input{book/3_results/shap_general}
...
%TC:ignore
\input{book/6_supplement/notebook_links}
%TC:endignore
